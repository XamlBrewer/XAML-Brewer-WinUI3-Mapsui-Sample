...
public static class GeoTiffDeployer
{
    ...
    public static void CopyEmbeddedResourceToFile(string geoTif)
    {
        ...
        assembly.CopyEmbeddedResourceToFile("XamlBrewer.WinUI3.Mapsui.Sample.Mapsui.Samples.Common.GeoData.GeoTiff.", GeoTiffLocation, geoTif + ".tfw");
        assembly.CopyEmbeddedResourceToFile("XamlBrewer.WinUI3.Mapsui.Sample.Mapsui.Samples.Common.GeoData.GeoTiff.", GeoTiffLocation, geoTif + ".tif");
    }
}
