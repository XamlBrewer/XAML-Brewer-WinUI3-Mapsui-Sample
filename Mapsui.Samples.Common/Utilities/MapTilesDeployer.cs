...
public static class MapTilesDeployer
{
    ...
    {
        assembly.CopyEmbeddedResourceToFile(@$"XamlBrewer.WinUI3.Mapsui.Sample.Mapsui.Samples.Common.GeoData.{mapTile}.{resourceFolder}.", MapTileLocation + @$"{Path.DirectorySeparatorChar}{mapTile}{Path.DirectorySeparatorChar}{folder}{Path.DirectorySeparatorChar}", $"{tile}.png");
    }
}
